...
$analysispath = "$subdirectories/temp_output/diffexpress_output/analysis_$analysisname";
...
$manyfilecommand = "python $subdirecotries/wayne_combiner_into_matrix.py 0 $analysispath $subdirectories/output_combiner.py $analysispath/out.txt $analysispath/cuffdiff_output/gene_exp.diff $rpath/edger.txt $rpath/deseq2.txt $rpath/bayseq.txt &&\n";
$manyfilecommand = "python $subdirecotries/wayne_combiner_into_matrix.py 1 $analysispath $subdirectories/output_combiner.py $analysispath/out.txt $analysispath/cuffdiff_output/gene_exp.diff $rpath/edger.txt $rpath/deseq2.txt $rpath/bayseq.txt &&\n";
$manyfilecommand = "python $subdirecotries/wayne_combiner_into_matrix.py 2 $analysispath $subdirectories/output_combiner.py $analysispath/out.txt $analysispath/cuffdiff_output/gene_exp.diff $rpath/edger.txt $rpath/deseq2.txt $rpath/bayseq.txt &&\n";
$manyfilecommand = "python $subdirecotries/wayne_combiner_into_matrix.py 3 $analysispath $subdirectories/output_combiner.py $analysispath/out.txt $analysispath/cuffdiff_output/gene_exp.diff $rpath/edger.txt $rpath/deseq2.txt $rpath/bayseq.txt &&\n";
$manyfilecommand = "python $subdirecotries/wayne_combiner_into_matrix.py 4 $analysispath $subdirectories/output_combiner.py $analysispath/out.txt $analysispath/cuffdiff_output/gene_exp.diff $rpath/edger.txt $rpath/deseq2.txt $rpath/bayseq.txt > matrix.txt &&\n";
...
$commands .= "R --vanilla < $bashdir/r_$mytimeid.R &&\n";
...
file_put_contents("$bashdir/r_$mytimeid.R", $rcommand, LOCK_EX);



#I want to see the commands for comparison to what is wanted and test out by hand     
#echo "$commands";
#echo "this is the set of commands !!!";
