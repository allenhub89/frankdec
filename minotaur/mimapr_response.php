...
if(empty(strip_tags (htmlspecialchars( escapeshellcmd($_POST['mirFilename']))))){
	exit("<h4>Error 5: Please choose one of the appropriate mirBase Files </h4>");
}

if(empty(strip_tags (htmlspecialchars( escapeshellcmd($_POST['minLength']))))){
	exit("<h4>Error 6: please choose an appropriate min Length of the reads </h4>");
}
