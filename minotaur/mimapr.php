...
{
        echo " <form id=\"submitform\" onsubmit=\"return valthisform(this);\" action=\"mimapr_response.php\" method=\"post\" target=\"formresponse\"> ";
}
...
function valthisform()
{
	...
	//var fqfile=document.getElementsByName("fqfilename[]");
	//var expcheckboxs=document.getElementsByName("fqfilename");
	var adapter = false;
	var inputokay=false;
	...
	alert(adpater + "is adapter");
	
	if(document.getElementById('adapter').value != "")
	{
		adapter=true;
	}
	...
	{
		alert("well, this isn't really working");	
	}
	return adapter && analysisokay;
...
<?php
$imageFiles = "/var/www/html/minotaur_out";
$minFiles = "$subdirectories/mirFiles";
$fqfiles = scandir("$minFiles/fastq_to_be_crunched");

#if the minotaur image file does not exist, then make it
if (!is_dir($imageFiles)) {
    mkdir($imageFiles);         
}
...
-->
<?php
echo "<br>Choose a minimum length </b></span><span class=\"helper\" id=\"help2\" style=\"color:blue;\"><b>?</b></span><br>";
?>
<script>
...
-->
<?php
echo "<span><br><b>Enter the adapter sequence: </b></h4></b></span><span class=\"helper\" id=\"help4\" style=\"color:blue;\"><b>?</b></span><br><br><input type=\"text\" id=\"adapter\" name=\"adapter\"> <br><br>";
...
-->
<div class='container'>
<button class="crunch" id="crunch" type="submit">Minotaur, Crunch!</button>
</form>
<br><br>
<form action="menu.php">
    <input align="bottom" type="submit" value="Return to MInotauR Menu">
</form>
</div>
</td>
